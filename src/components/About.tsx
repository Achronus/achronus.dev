...
const Title = ({ name }: { name: string }) => {
  return (
    <div className="title gap-2 md:mt-2">
      <h2 className="mt-3 font-medium text-3xl lg:mb-3">{name}</h2>
    </div>
  );
};
...
const Details = ({
  ...
  return (
    <>
      ...
      <div className="socials justify-center lg:justify-start flex gap-6 mt-4">
